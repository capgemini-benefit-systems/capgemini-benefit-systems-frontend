...
let counter = 0;
function createData(rank, name, cost) {
  counter += 1;
  return { id: counter, rank, name, cost };
}

  function createRows(awards) {
    var i = 1;
    return awards.map(user => createData(i++, user.name, user.cost))
  }
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell style = {textStyle} align="right">{n.cost}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
